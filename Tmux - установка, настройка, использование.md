...
Управлять `tmux` можно двумя способами - командами и клавиатурными сокращениями. В обще самая распространенная схема такова - запуск, подключение к сессии, просмотр списка сессий с помощью команд, а управление внутри мультиплексора - с помощью сокращений.
