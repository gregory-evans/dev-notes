...
Одна из современных командных оболочек. Имеет большое количество улучшений и новых возможностей в сравнении с `Bash`, с которой поддерживает обратную совместимость.
...
Установим скрипт кастомизации OhMyZsh. Подробности об установке по адресу https://github.com/ohmyzsh/ohmyzsh/wiki, откуда берем и выполняем команду:
