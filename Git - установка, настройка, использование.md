...
Здесь рассматривается только консольная версия клиента.

## Установка

### Windows

Я использую максимально дефолтный клиент,  который можно взять по адресу https://git-scm.com/install/windows. Скачиваем подходящую для нашей системе версию (x64/Arm64) и устанавливаем как обычное приложение. При установке можно оставлять все рекомендуемые опции.
